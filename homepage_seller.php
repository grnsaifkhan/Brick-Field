...
<center><h1><font color="#00bcd4">USERS INFORMATION</font></h1></center>
...
<?php 
    ...
    $sql = "DELETE FROM signup_buyer where id = $id";
...
try {
     ...
     $stmt = $conn->prepare("SELECT id, first_name, last_name,username,password FROM signup_buyer"); 
     $stmt->execute();
