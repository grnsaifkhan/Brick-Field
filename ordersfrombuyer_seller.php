...
<?php 
    ...
    $sql = "DELETE FROM productorder_buyer where id = $id";
...
echo "<table style='border: solid 1px black;'>";
  echo "<tr><th>Id</th><th>Product Type</th><th>Size</th><th>Quantity</th><th>mobile No.</th></tr>";
...
try {
     ...
     $stmt = $conn->prepare("SELECT id, type,size,quantity,mobile FROM productorder_buyer"); 
     $stmt->execute();
